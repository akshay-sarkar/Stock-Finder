...
export function FinancialsWidget({ data, ticker }: { data: FinancialsData; ticker?: string }) {
    ...
    <div>
      ...
      <div className="mb-3">
        {ticker ? (
          ...
          <h3 className="text-sm font-semibold text-gray-700">Historical Financials</h3>
        )}
      </div>

      {!rows.length ? (
        <p className="text-xs text-gray-400 italic">Financial data not available</p>
      ) : (
        <>
          {/* Tab toggle */}
